...
namespace BearingCAD22
{
    ...
    public class clsUnit
    {
        ...
        //=====================
            ...
            public double CFac_GPM_EngToMet(String FlowReqd_Unit, double GPM_In)
            //-------------------------------------------------------------
            {   //....Convert GPM ==> LPM.
                //........1 gal = 3.7854 liter.
                Double pVal = 0.0;
                if (FlowReqd_Unit == "LPM")
                {
                    pVal = (GPM_In * 3.7854);
                }
                else if (FlowReqd_Unit == "LPS")
                {
                    pVal = (GPM_In / 15.8503);
                }
            ...
            public double CFac_LPS_MetToEng(double LPS_In)
            //-------------------------------------------------------------
            {   //....Convert LPS ==> GPM.
                return (LPS_In * 15.8503);
            }
